        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl md:text-2xl mb-8 text-blue-100">
              Discover amazing products from trusted suppliers worldwide
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {featuredProducts.length > 0 ? (
            ...
            <div className="text-center py-12 bg-white rounded-lg">
              ...
              <p className="text-gray-500 mt-2">Check back soon or browse all products!</p>
              <Link
                href="/products"
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Curated selection from trusted suppliers worldwide
              </p>
            </div>
            <div className="text-center">
              <div className="bg-blue-100 rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-4">
              ...
              <p className="text-gray-600">
                Quick delivery directly from our supplier partners
              </p>
            </div>
            <div className="text-center">
              <div className="bg-blue-100 rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-4">
